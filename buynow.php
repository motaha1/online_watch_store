...
$sql1 = " INSERT INTO `buynow` (`p_id`, `user_id`, `quantity`) VALUES ('$info','$user_id' , '1') "; 
...
$sql = "SELECT * FROM `viewbuynow` where `id` = '$info'"; 
...
?>
                  <tr>
                    ...
                    <!-- <td><a href="deletebuynow.php?proid= <?= $pro['id'];?> " class="btn btn-danger">delete</a></td> -->
                  </tr>
                  <?php   endforeach; ?>
                  </tbody>
                  <tfoot>
              ...
              <button  id="go-shopping" ><a  href="delete.php">continue shopping</a></button>

    

              <td><a href="clickbuynow.php " onclick="myalert()" class="btn btn-danger">buy now</a></td>
